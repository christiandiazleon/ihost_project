# -*- coding: utf-8 -*-
# Generated by Django 1.10.7 on 2017-07-13 16:10
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('entertainment_activities', models.ManyToManyField(to='host_information.EntertainmentActivities')),
                ('groups', models.ManyToManyField(blank=True, help_text='The groups this user belongs to. A user will get all permissions granted to each of their groups.', related_name='user_set', related_query_name='user', to='auth.Group', verbose_name='groups')),
                ('speak_languages', models.ManyToManyField(help_text='What services do you offer?', related_name='users', to='host_information.SpeakLanguages', verbose_name='Languages')),
